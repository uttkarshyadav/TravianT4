...
{
b10: '<p><div style="color:#F90">Experience: <?php echo $hero['experience']; ?><br>More experienced: 10<br>Experience after use: <?php echo ($hero['experience']+10); ?><br></div>',
b15: '<table id="heroInventoryDataDialog" class="transparent" cellspacing="0" cellpadding="0"><tbody><tr class="rowBeforeUse"><th>Current ratio Cultural Point</th><td><?php echo $database->getUserField($session->uid, 'cp',0); ?></td></tr><tr class="rowUseValue"><th>Culture Points obtained after taking art:</th><td class="displayUseValue"><?php echo $database->getVSumField($session->uid, 'cp'); ?></td></tr><tr class="rowAfterUse"><th>Culture points after taking artwork:</th><td class="displayAfterUse"><?php echo ($database->getUserField($session->uid, 'cp',0)+$database->getVSumField($session->uid, 'cp')); ?></td></tr></tbody></table>',
alreadyOpen: false,
